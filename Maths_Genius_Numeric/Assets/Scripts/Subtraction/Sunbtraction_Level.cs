...
public class Sunbtraction_Level : MonoBehaviour
{
    ...
    public void Generate_Question()
    {
        ...
        int num2 = Utilities.GetRandomNumber(1, num1-1);
    ...
    public void Populate_Grid()
    {
        ...
        for (int i = 0; i < leftPos.Count; i++)
        {
            ...
            if ((Question_Elements[0] - i) <= Answer)
            {
                gridItem.ActivateCanClick();
            } else
            {
                gridItem.Deactivate_Object();
            }
    ...
    {
        UI_Manager.instance.substraction_Screen.Back_Button.gameObject.SetActive(false);
        ...
        UI_Manager.instance.substraction_Screen.Back_Button.gameObject.SetActive(true);
